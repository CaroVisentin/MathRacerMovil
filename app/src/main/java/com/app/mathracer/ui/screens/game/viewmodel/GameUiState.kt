...
data class GameUiState(
    ...
    ,
    val doubleProgressActive: Boolean = false, // Cuando se activa, la siguiente respuesta correcta avanza 2 lugares
    val lastPowerUpMessage: String? = null // Mensaje corto para feedback visual
